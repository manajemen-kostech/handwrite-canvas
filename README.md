...
* Background video:  tag with autoPlay, loop, muted, playsInline. Positioned absolute left-0 w-full h-auto object-contain z-0 with top: 20%. Source is the CloudFront MP4 URL. Poster is /images/hero_bg.jpeg.
...
* Each word/letter is a  that animates from {filter: 'blur(10px)', opacity: 0, y: 50} (when direction=bottom) through {filter: 'blur(5px)', opacity: 0.5, y: -5} to {filter: 'blur(0px)', opacity: 1, y: 0}
...
OVERALL PAGE STRUCTURE
               ...
               -- fixed floating nav
                 -- 1000px tall, CloudFront MP4 video bg
    


         -- HLS video bg, "How It Works"
        -- alternating text/gif rows
         -- 4-card grid
                -- HLS video bg (desaturated), stats card
         -- 3-card grid
            -- HLS video bg, CTA + footer
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/b9eff324-736f-4c9a-9ab2-bc2810155298).
